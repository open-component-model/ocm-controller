...
require (
	...
	github.com/fluxcd/image-automation-controller/api v1.2.3 // indirect
	github.com/fluxcd/image-reflector-controller/api v1.2.3 // indirect
	github.com/fluxcd/notification-controller/api v1.9.2 // indirect
